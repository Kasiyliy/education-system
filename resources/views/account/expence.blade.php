                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="row">
                                ...
                                <form class="form-horizontal form-label-left custom-error" method="post"
                                      action="{{URL::route('accounting.income.store')}}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="item form-group">
                                                <label class="control-label" for="name">Sector <span
                                                            class="required">*</span>
                                                </label>
                                        ...
                                        <div class="col-md-2">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control accDate" name="date"
                                                       value="{{$today->format('d/m/Y')}}" required="required"/>
                                        ...
                                        <div class="col-md-2">
                                            <button type="submit" class="btn btn-lg btn-primary btn-attend"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form class="deleteForm" method="get"
                                                          action="{{URL::route('accounting.expence.destroy',$expence->id)}}">
