            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                            ...
                            <div class="x_title">
                                <h2>Quiz
                                    <small> Student Quiz Mark Entry</small>
                                </h2>
                            ...
                            <div class="x_content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="item form-group">
                                            <label class="control-label" for="subject_id">Subject <span
                                                        class="required">*</span>
                                            </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="item form-group">
                                            <label class="control-label" for="subject_id">Quiz name<span
                                                        class="required">*</span>
                                            </label>

                                            <input id="name" type="text" class="form-control col-md-7 col-xs-12"  name="name" value="{{old('name')}}" placeholder="Название теста" required="required" type="text">
