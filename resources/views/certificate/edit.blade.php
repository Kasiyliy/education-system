                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="text1" type="text" class="form-control col-md-7 col-xs-12"
                                               name="text1"
                                               value="{{$certificate->text1}}" maxlength="24" placeholder="text1">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="text2" type="text" class="form-control col-md-7 col-xs-12"
                                               name="text2"
                                               value="{{$certificate->text2}}" maxlength="24" placeholder="text2">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="text3" type="text" class="form-control col-md-7 col-xs-12"
                                               name="text3"
                                               value="{{$certificate->text3}}" maxlength="24" placeholder="text3">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="text4" type="text" class="form-control col-md-7 col-xs-12"
                                               name="text4"
                                               value="{{$certificate->text4}}" maxlength="24" placeholder="text4">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="text5" type="text" class="form-control col-md-7 col-xs-12"
                                               name="text5"
                                               value="{{$certificate->text5}}" maxlength="24" placeholder="text5">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="text6" type="text" class="form-control col-md-7 col-xs-12"
                                               name="text6"
                                               value="{{$certificate->text6}}" maxlength="24" placeholder="text6">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="text7" type="text" class="form-control col-md-7 col-xs-12"
                                               name="text7"
                                               value="{{$certificate->text7}}" maxlength="24" placeholder="text7">
