                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                <thead>
                                <tr>
                                    <th>{{trans('messages.disciplina_text2')}}</th>
                                    <th>{{trans('messages.disciplina_text3')}}</th>
                                    <th>{{trans('messages.disciplina_text4')}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a title='Update' class='btn btn-info btn-xs btnUpdate'
                                               id='{{$department->id}}'
                                               href='{{URL::route('department.edit',$department->id)}}'> <i
                                                        class="glyphicon glyphicon-check icon-white"></i></a>
                                            <form class="deleteForm" method="POST"
                                                  action="{{URL::route('department.destroy',$department->id)}}">
