                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left" novalidate method="post"
                                  action="{{URL::route('department.update',$department->id)}}">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="name" type="text" class="form-control col-md-7 col-xs-12" name="name"
                                               ...
                                               placeholder="{{trans('messages.disciplina_text2')}}" required="required"
                                               type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="code" class="form-control col-md-7 col-xs-12" name="code"
                                               ...
                                               placeholder="{{trans('messages.disciplina_text3')}}" required="required">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea id="description" required="required" name="description"
                                                  class="form-control col-md-7 col-xs-12">{{$department->description}}</textarea>
