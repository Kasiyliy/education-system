	...
	<div class="">
		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Изменение информации студента<small class="text-danger"> * обязательные поля для заполнения.</small></h2>
						...
						<form id="myForm" class="form-horizontal form-label-left" novalidate method="post" action="{{URL::route('student.update',$student->id)}}" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-md-2 col-sm-6 col-xs-12">
									...
									<p>
										...
										<input type="radio" class="flat" name="gender" id="genderM" value="Male" checked=""  /> жен.:
										<input type="radio" class="flat" name="gender" id="genderF" value="Female" />
										@else
										<input type="radio" class="flat" name="gender" id="genderM" value="Male"   /> жен.:
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<input type="text" id="mobileNo" class="form-control has-feedback-left" data-inputmask="'mask': '+7 9999999999'" value="{{$student->mobileNo}}" name="mobileNo" required />
							...
							<br><br>
							<button type="submit" name="" class="btn btn-primary">Изменить</button>
