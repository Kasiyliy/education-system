...
class StudentController extends Controller
{
    ...
    {
        $this->middleware('admin', ['except' => ['teacherStudentList']]);
    ...
    public function teacherStudentList($id)
    {
        $students = Student::select('students.firstName as firstName', 'students.lastName as lastName', 'students.middleName as middleName',
            'subject.name as subject')
            ->leftJoin('registrations', 'students.id', '=', 'registrations.students_id')
            ->leftJoin('subject', 'registrations.subject_id', '=', 'subject.id')
            ->where('subject.user_id', '=', $id)
            ->get();
        return view('student.teacher_student', compact('students'));
    }
